document.addEventListener("DOMContentLoaded", () => {
    ...
    fetch(apiUrl)
        ...
        .then(response => {
            ...
            if (!response.ok) {
                ...
                throw new Error(
                    "Hittade inga priser för dagens datum."
                );
        ...
        .then(data => {
            ...
            const currentIndex =
                currentHour * 4
                + Math.floor(currentMinute / 15);


            const currentPrice =
                data[currentIndex]
                    ? data[currentIndex].SEK_per_kWh
                    : data[0].SEK_per_kWh;
    ...
    fetch(apiUrl)
        ...
        .then(response => {
            ...
            if (!response.ok) {
                ...
                throw new Error(
                    "Hittade inga priser för grafen."
                );
    ...
    const map =
        L.map("contactMap")
            .setView([59.440671, 18.062999], 15);
